...
router.post('/payment-on-delivery/create-order', async (req, res) => {
...
router.post('/card/create-order', async (req, res) => {
  const { userid, productid, colorid, sizeid, paymentid , paymentStatus} = req.body;
...
router.get('/checkout/product-details/:productid/:sizeid/:colorid', async (req, res) => {
...
router.post("/create/payment/create-payment-intent", async (req, res) => {
