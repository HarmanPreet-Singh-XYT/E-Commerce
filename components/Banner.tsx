...
const Banner = () => {
  return (
    <div className='flex rounded-xl flex-row min-h-[460px] lg:max-w-[1300px] overflow-x-auto gap-2 snap-mandatory snap-x mt-4'>
      {banners.map((each,index)=>
      <div key={index} className='flex-shrink-0 snap-center'>
        <div className='relative'>
          <img className='max-h-[450px] z-10 rounded-xl object-cover lg:min-w-[1300px]' src={each.imgLink} />
