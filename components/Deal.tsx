...
const Deal = () => {
  return (
    <div className=' mt-10 sm:ml-4 ml-auto mr-auto max-w-[350px] sm:max-w-[1000px] flex flex-col justify-center'>
        <p className='border-b-[1px] leading-[50px] tracking-[1.5px] font-bold text-[20px]'> Deal of The Day</p>
        <div className='p-[30px] border-[1px] mt-8 rounded-xl overflow-y-auto snap-x snap-proximity'>
            <div className='flex flex-col rounded-xl gap-5 h-auto items-center sm:pl-10 snap-center sm:flex-row'>
                ...
                <div className='flex flex-col gap-4'>
                    <p>5 stars</p>
                    <a href="">
                        <p className='text-[18px] font-bold w-full'>SHAMPOO, CONDITIONER & FACEWASH PACKS</p>
                    </a>
                    <p className='text-base tracking-[0.5px] text-silver'>Lorem ipsum dolor sit amet consectetur Lorem ipsum dolor dolor sit amet consectetur Lorem ipsum dolor</p>
                    ...
                    <p className='text-sm font-bold'>HURRY UP! OFFER ENDS IN:</p>
