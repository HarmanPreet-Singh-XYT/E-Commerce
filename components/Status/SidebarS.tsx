        ...
        <>
            <div className='hidden lg:flex-col lg:flex ml-auto'>
                <div className='border-[1px] rounded-xl h-auto w-[320px] p-[15px]'>
                    <p className='tracking-[3px] font-bold text-[18px] mb-4'>CATEGORY</p>
                            ...
                            >
                                <div className='flex justify-between items-center w-[100%] text-[20px]'>
                                    <div className='flex justify-center items-center'>
                                        ...
                                        <p className='text-[19px] text-silver tracking-[1px]'>{stat.title}</p>
                                    </div>
                                    <p>{collapsedIndex === index ? '-' : '+'}</p>
                                </div>
                            </div>
                ...
                <div className='h-[500px] mt-10'>
                    <p className='font-bold tracking-wider text-lg'>BEST SELLERS</p>
                    <div className='flex flex-col'>
                        {bestSell.map((each, index) =>
                            <div key={index} className='flex mt-5'>
                                ...
                                <div className='ml-5'>
                                    <a href={each.productLink}>
                                        <p className='tracking-[1px] text-[17px] text-davysilver'>{each.title}</p>
                                    </a>
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <p className='text-lg font-bold ml-4 text-davysilver'>${each.discountPrice.toFixed(2)}</p>
                                    </div>
                                </div>
                            </div>
                        )}
