...
router.post('/user/addresses', async (req: Request, res: Response) => {
...
router.post('/user/cart-items', async (req: Request, res: Response) => {
    const { userID } = req.body;
    try {
...
router.post('/user/coupons', async (req: Request, res: Response) => {
    const { userID } = req.body;
...
router.post('/user/all-data', async (req: Request, res: Response) => {
...
router.post('/user/insert/cartitem',async(req:Request,res:Response)=>{
    const { userID, productID, quantity, sizeID, colorID } = req.body;
    const cartItemID = IDGenerator();
...
router.delete('/user/delete/cartitem',async(req:Request,res:Response)=>{
...
router.post('/user/insert/wishlistitem',async(req:Request,res:Response)=>{
...
router.delete('/user/delete/wishlistitem',async(req:Request,res:Response)=>{
...
router.get('/user/order-detail/:userIDToken/:orderID',async (req:Request,res:Response)=>{
    const { userIDToken,orderID } = req.params;
    const query = `SELECT 
    orders.orderid,
    orders.createdat,
